...
public class AllocataireMapper extends Mapper {
    ...
    public boolean deleteById(long id) {
        ...
        if (versements.isEmpty()) {
            ...
            try (PreparedStatement preparedStatement = cnn.prepareStatement("DELETE FROM ALLOCATAIRES WHERE NUMERO=?")) {
            ...
            System.out.println("Allocataire avec des versements existants");
        }
        return false;
    }
    ...
    public boolean updateById(long id, Allocataire allocataire) {
        ...
        if (!oldAllocataire.equals(oldAllocataire)) {
            Connection cnn = getConnection();
            try (PreparedStatement preparedStatement = cnn.prepareStatement("UPDATE ALLOCATAIRES SET NOM = ?, PRENOM = ? WHERE NUMERO=?")) {
            ...
            System.out.println("Aucun changement pour l'allocataire");
        }
        return false;
    }
